...
print(Result)
save(Result,Table_r_bic,Table_r_psr,Table_r_testloss,Table_r_trainloss,Table_r_model_size, file = paste0(correlation,num_Simu,"_N",train_size,"_P",P,"Binomial"))
